...
const EmailBody = ({ id, page }: { id: string; page: number }) => {
  ...
  return (
    <Card
      className={`group flex-col items-start rounded-none lg:rounded-xl hover:shadow-lg hover:shadow-primary/20 hover:duration-300 text-sm h-[70vh] lg:h-[88vh] p-6 `}
    >
